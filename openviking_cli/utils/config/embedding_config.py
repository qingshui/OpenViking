...
class EmbeddingModelConfig(BaseModel):
    ...
    provider: Optional[str] = Field(
        default="volcengine",
        description=(
            "Provider type: 'openai', 'volcengine', 'vikingdb', 'jina', 'ollama', 'voyage', 'openai_compatible'. "
    ...
    def validate_config(self):
        ...
        valid_providers = ["openai", "volcengine", "vikingdb", "jina", "ollama", "voyage", "openai_compatible"]
        if self.provider not in valid_providers:
            raise ValueError(
                f"Invalid embedding provider: '{self.provider}'. Must be one of: "
                "'openai', 'volcengine', 'vikingdb', 'jina', 'ollama', 'voyage', 'openai_compatible'"
            )
...
class EmbeddingConfig(BaseModel):
    ...
    def _create_embedder(
        ...
        Args:
            provider: Provider type ('openai', 'volcengine', 'vikingdb', 'jina', 'ollama', 'voyage', 'openai_compatible')
